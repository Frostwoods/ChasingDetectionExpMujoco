...
def main():
    ...
    trajectoriesSaveDirectory ='../PataData/exp1Traj'
    ...
    trial = ChaseTrialMujoco(conditionsWithId,displayFrames,reactionWindowStart, drawState, drawImage, stimulus, checkHumanResponse, colorSpace, numOfAgent, drawFixationPoint, drawText, drawImageClick, clickWolfImage, clickSheepImage, FPS)
