...
from src.trial import ChaseTrialMujoco, CheckHumanResponse,ChaseTrialMujocoWithLineRope,ChaseTrialMujocoWithLineRopePhysical
...
def main():
    ...
    manipulatedVariables['tiedPairs'] = [[0,2],[2,4]]
    ...
    introductionImage1 = pygame.image.load(os.path.join(picturePath, 'physicalIntro1.png'))
    introductionImage2 = pygame.image.load(os.path.join(picturePath, 'physicalIntro2.png'))
    ...
    clickWolfImage = pygame.image.load(os.path.join(picturePath, 'clickActive.png'))
    clickSheepImage = pygame.image.load(os.path.join(picturePath, 'clickPassive.png'))
    ...
    trial = ChaseTrialMujocoWithLineRopePhysical(conditionsWithId,displayFrames, drawState, drawImage, stimulus, checkHumanResponse, colorSpace, numOfAgent, drawFixationPoint, drawText, drawImageClick, clickWolfImage, clickSheepImage, FPS)
