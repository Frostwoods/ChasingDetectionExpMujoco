...
if __name__ == '__main__':
    ...
    # dataPath = os.path.join(DIRNAME,'..','results','exp1')
    dataPath = os.path.join(DIRNAME,'..','..','ExpResult','512','result')
    ...
    for name, grp in df2.groupby('name'):
    ...
    # for damping, grp in df3.groupby('damping'):
