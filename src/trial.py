...
class ChaseTrialMujoco():
    def __init__(self, conditionsWithId,displayFrames,reactionWindowStart, drawState, drawImage, stimulus, checkHumanResponse, colorSpace, numOfAgent, drawFixationPoint, drawText, drawImageClick, clickWolfImage, clickSheepImage, fps):
        self.conditionsWithId = conditionsWithId
        self.displayFrames = displayFrames
